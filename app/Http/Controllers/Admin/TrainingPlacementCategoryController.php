...
class TrainingPlacementCategoryController 
{
    public function __construct()
    {
        ...
        $this->permission               = 'training_placement_category';
        $this->route                    = 'training_placement_category';
    ...
    {     
        ...
        $results                      = TrainingPlacementCategory::where('status', 1);
        if ($searchQuery) {
    ...
    public function store(Request $request)
    {
        ...
        // Create a new post
        TrainingPlacementCategory::create($all);
    ...
    public function show($id)
    {
        ...
        $results                        = TrainingPlacementCategory::findOrFail($id);
    ...
    public function update(Request $request, $id)
    {
        ...
        $result                        = TrainingPlacementCategory::findOrFail($id);
        $result->update($all);
    ...
    public function destroy(TrainingPlacementCategory $trainingPlacementCategory)
    {
        if(!auth()->user()->hasPermission('delete_'.$this->permission))
        {
            abort(404, 'You are not Authorised...');
        }
        $trainingPlacementCategory->delete();
