...
class TrainingPlacementController 
{
    public function __construct()
    {
        ...
        $this->permission               = 'training_placement';
        $this->route                    = 'training_placement';
    ...
    {     
        ...
        $results                      = TrainingPlacement::where('status', 1);
        if ($searchQuery) {
    ...
    public function create()
    {
        ...
        $categories                          = TrainingPlacementCategory::all();
    ...
    public function store(Request $request)
    {
        ...
        if (isset($all['image']))
        {
            ...
            $image->move(config('app.training_img'), $imageName);
    ...
    public function show($id)
    {
        ...
        $results                        = TrainingPlacement::findOrFail($id);
    ...
    public function update(Request $request, $id)
    {
        ...
        $result                        = TrainingPlacement::findOrFail($id);
        $result->update($all);
