        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-8 offset-md-2">
                    <form action="{{ route('business_category.index') }}" method="GET">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    @if(auth()->user()->hasPermission('create_business_category'))
                      <a class="float-right" href="{{ route('business_category.create') }}" >
                  ...
                  <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <form action="{{ route('business_category.activeStatus', $result->id) }}" method="POST">
                              @csrf
                              <label class="switch">
                        ...
                        <td>
                          @if(auth()->user()->hasPermission('show_business_category'))
                          ...
                          @if(auth()->user()->hasPermission('delete_classified_category'))
                            |
                              <form action="{{ route('business_category.destroy', $result->id) }}" method="post" class="d-inline">
                                @csrf
                                @method('DELETE')
