                      ...
                      <div class="row">
                          <div class="col-sm-12">
                              <div class="form-group row">
                                  ...
                                  <div class="col-sm-12">
                                      <input type="text" class="form-control" id="ad_name" name="ad_name" value="{{ $results->ad_name }}" placeholder="Enter title">
                                  </div>
                              </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="textbox" id="amount" name="amount" class="form-control" value="{{ $results->amount }}" placeholder="enter amount" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="click_url" name="click_url" value="{{ $results->click_url }}" placeholder="Enter Url">
                                    </div>
                                </div>
                            </div>
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control" name="ad_position" id="ad_position">
                                      ...
                                      <option value="top" {{ $results->ad_position == 'top' ? 'selected' : '' }} >Top</option>                                      
                                      <option value="left" {{ $results->ad_position == 'left' ? 'selected' : '' }} >Left</option>                                      
                                      <option value="right" {{ $results->ad_position == 'right' ? 'selected' : '' }} >Right</option>                                      
                                  </select> 
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="ad_contact" name="ad_contact" value="{{ $results->ad_contact }}" placeholder="Enter Contact">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control" rows="4" id="ad_address" name="ad_address" placeholder="Enter address">{{ $results->ad_address }}</textarea>
                                    </div>
                                </div>
                            </div>
