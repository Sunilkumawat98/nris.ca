...
@section('title', 'Nris Dashboard | Classified Category Edit')
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item">Classified Category</li>
          ...
          <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Create Classified Category</h3>
                </div>
                @if ($errors->any())
                ...
                @endif
                <form action="{{ route('classified_category.update', $results->id) }}" method="POST">
              @csrf
              @method('PUT')
                <!-- /.card-header -->
              <div class="card-body">
