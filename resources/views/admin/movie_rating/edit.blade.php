...
@section('title', 'Nris Dashboard | Movie Rating Edit')
          ...
          <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Edit Movie Rating</h3>
                </div>
                @if ($errors->any())
                      ...
                      <div class="col-md-6">
                        <div class="card-body">             
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="url" name="rating_data[{{$source->id}}][1]" value="
                                <?php 
                                    echo isset($rating->rating_data[$source->id]) ? str_replace(' ', '', $rating->rating_data[$source->id][1]) : ''; ?>" placeholder="Enter source url">
                            </div>
                        </div>
                      </div>
                    </div>
