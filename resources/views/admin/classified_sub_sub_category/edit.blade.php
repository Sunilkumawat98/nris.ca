  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Classified Sub Sub Category Edit</h1>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item">Edit Classified Sub Sub Category</li>
          ...
          <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Edit Classified Sub Sub Category</h3>
                </div>
                @if ($errors->any())
                ...
                @endif
                <form action="{{ route('classified_sub_sub_category.update', $results->id) }}" method="POST">
              @csrf
              @method('PUT')
                <!-- /.card-header -->
              <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control select2 select2-danger" name="sub_category_id" id="sub_category_id" data-dropdown-css-class="select2-danger" style="width: 100%;">
                        ...
                        @foreach($categories as $item)
                              <option value="{{ $item->id }}" {{ $results->sub_category_id == $item->id ? 'selected' : '' }} > {{ $item->name }}</option>
                        @endforeach
                    </select>
