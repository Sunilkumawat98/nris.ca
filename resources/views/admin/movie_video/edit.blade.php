                          ...
                          <div class="row">    
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control select2 select2-danger" name="language_id" id="language_id" data-dropdown-css-class="select2-danger">
                                      ...
                                      @foreach($languages as $item)
                                            <option value="{{ $item->id }}" {{ $results->language_id == $item->id ? 'selected' : '' }} >{{ $item->name }}</option>
                                      @endforeach
                                  </select> 
                                </div>
                              </div>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="link" name="link" value="{{ $results->link }}" placeholder="Enter Url">
                                    </div>
                                </div>
                            </div>
