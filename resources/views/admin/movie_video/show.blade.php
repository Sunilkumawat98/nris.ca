                  ...
                  <div class="row">
                    <div class="col-8">
                      <div class="post">
                        ...
                        <p>
                           Category : {{ ($results->category_id) ? getMovieVideoCategoryNamebyId($results->category_id)->name : 'NA' }}
                        </p>
                        
                       
                        <p>
                           Language : {{ ($results->language_id) ? getMovieVideoLanguageNamebyId($results->language_id)->name : 'NA' }}
                        </p>
