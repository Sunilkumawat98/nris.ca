...
@php
    $page_name = 'Student Talk';
    $routeUrl = 'student_talk';
    $permission = 'student_talk';
@endphp
...
@foreach(getAllUniversity() as $value)
    @php
      $university[$value->id] =  $value->name
    @endphp
@endforeach    
...
@foreach(getAllState() as $val)
    ...
    @endphp
@endforeach
@foreach(getAllStudentTalkCategory() as $val)
    @php
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                      ...
                      <tr>
                        ...
                        <td>{{ $result->title }} </td>
                        <td>{{ $university[$result->university_id] }}</td></td>
                        
                        <td>{{ $country[$result->country_id] }}</td>
                        <td>
